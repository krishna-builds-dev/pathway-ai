        ...
        <>
            <section className="relative px-margin py-stack-lg max-w-container-max mx-auto overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-stack-lg items-center">
                    {/* ---- Text content (z-10 stays as before) ---- */}
                    <div className="z-10 order-2 lg:order-1">
                        ...
                        <p className="font-body-lg text-md md:text-body-lg text-on-surface-variant mb-stack-md max-w-lg">
                            {user
                                ...
                                : "Navigate the complexity of studying abroad with our AI-powered planning platform. Discover unique university pathways tailored to your unique goals."}
                        </p>
                    ...
                    <div className="relative order-2 lg:order-2">
                        ...
                        {/* Floating badge – hidden on very small screens, visible from sm upward */}
                        <div className="absolute bottom-6 left-6 glass-card p-6 rounded-xl shadow-xl max-w-xs hidden lg:block">
                            <div className="flex items-center gap-4 mb-2">
                                <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-on-primary">
                                    <span className="material-symbols-outlined select-invert">auto_awesome</span>
                                </div>
                                <div>
                                    <div className="text-h2-dashboard font-bold">15,000+</div>
                                    <div className="text-ui-sm text-on-surface-variant">Successful Placements</div>
                                </div>
                            </div>
                        </div>
                    </div>
